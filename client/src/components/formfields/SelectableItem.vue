...
<template>
  ...
  >
    ...
    <button
      ...
      type="button"
      data-canvas-action
      class="absolute -right-3 -top-3 z-20 flex h-7 w-7 items-center justify-center rounded-full bg-destructive-surface text-destructive shadow-sm transition hover:bg-destructive/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-destructive/30"
      :class="active
        ? 'opacity-100'
