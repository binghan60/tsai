            ...
            <CalendarCellTrigger
              ...
              :class="
                cn(
                  ...
                  'data-[selected]:border data-[selected]:border-primary/60 data-[selected]:bg-primary/10 data-[selected]:text-primary data-[selected]:hover:bg-primary/15',
                  'data-[today]:data-[selected]:border-0 data-[today]:data-[selected]:bg-primary data-[today]:data-[selected]:text-primary-foreground',
