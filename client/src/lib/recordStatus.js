export const RECORD_STATUS_META = {
  ...
  draft: { label: '草稿', class: 'bg-muted/60 text-foreground' },
...
export const DELIVERY_STATUS_META = {
  ...
  not_sent: { label: '未寄送', class: 'bg-muted/60 text-foreground' },
  ...
  uncertain: { label: '結果待確認', class: 'bg-amber-50 text-amber-800 dark:bg-amber-500/10 dark:text-amber-300' },
};
