...
GET    /api/appointments                當日掛號時間軸（?date=YYYY-MM-DD，預設今天）；另回 patientNotes { pets, owners }，
                                       以 id 為鍵的寵物／飼主備註（空白不回），給診療台佇列顯示「會咬人」之類的提醒
